...
if __name__ == '__main__':
    ...
    plot_data(acce_00, "test_00_acce_row.png",  ['AcceX','AcceY','AcceZ'])
    plot_data(ahrs_00, "test_00_ahrs_row.png",  ['PitchX', 'RollY', 'YawZ'])
    velo_00 = do_velocity(acce_00)
    plot_data(velo_00, "test_00_velo_row.png",  ['VeloX', 'VeloY', 'VeloZ'])

    acce_nog_00 = do_remove_gravity(acce_00)
    plot_data(acce_nog_00, "test_00_acce_nog.png", ['AcceX','AcceY','AcceZ'])
    velo_nog_00 = do_velocity(acce_nog_00)
    plot_data(velo_nog_00, "test_00_velo_nog.png",  ['VeloX', 'VeloY', 'VeloZ'])

    posi_15, acce_15, gyro_15, magn_15, ahrs_15 = read_log_file("test_15.log")
    plot_data(acce_15, "test_15_acce_row.png", ['AcceX','AcceY','AcceZ'])
    plot_data(ahrs_15, "test_15_ahrs_row.png",  ['PitchX', 'RollY', 'YawZ'])
    velo_15 = do_velocity(acce_15)
    plot_data(velo_15, "test_15_velo_row.png",  ['VeloX', 'VeloY', 'VeloZ'])

    acce_nog_15 = do_remove_gravity(acce_15)
    plot_data(acce_nog_15, "test_15_acce_nog.png", ['AcceX','AcceY','AcceZ'])
    velo_nog_15 = do_velocity(acce_nog_15)
    plot_data(velo_nog_15, "test_15_velo_nog.png",  ['VeloX', 'VeloY', 'VeloZ'])

    posi_tr, acce_tr, gyro_tr, magn_tr, ahrs_tr = read_log_file("track.log")
    ...
    plot_data(acce_tr, "track_acce_row.png",  ['AcceX','AcceY','AcceZ'])
    plot_data(ahrs_tr, "track_ahrs_row.png",  ['PitchX', 'RollY', 'YawZ'])
    velo_tr = do_velocity(acce_tr)
    plot_data(velo_tr, "track_velo_row.png",  ['VeloX', 'VeloY', 'VeloZ'])

    acce_nog_tr = do_remove_gravity(acce_tr)
    plot_data(acce_nog_tr, "track_acce_nog.png", ['AcceX','AcceY','AcceZ'])
    velo_nog_tr = do_velocity(acce_nog_tr)
    plot_data(velo_nog_tr, "track_velo_nog.png",  ['VeloX', 'VeloY', 'VeloZ'])
